(function () {
  ...
  const cardCanvas = (card, index) => {
    ...
    y=panel(cardLabels.letters,card.letters,y,'#edf8f8')+42;
    ...
    ctx.fillStyle='#29235c';ctx.beginPath();ctx.roundRect(70,y,w-140,casesHeight,28);ctx.fill();ctx.textAlign=rtl?'right':'left';ctx.font=font('700',29);ctx.fillStyle='#f5c372';ctx.fillText(cardLabels.examples,x,y+57);y+=104;
