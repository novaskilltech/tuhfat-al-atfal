(function () {
  ...
  window.TUHFA = { language:'fr', title:'Tuḥfat al-aṭfāl, pas à pas', ui,
    ...
    lessons: ar.lessons.map((lesson,i) => { const m=meta[i]; return {id:lesson.id,title:m[0],range:m[1],rule:m[2],terms:m[3],example:m[4],warning:m[5],exercise:m[6],verses:lesson.verses}; }),
    glossary:[
